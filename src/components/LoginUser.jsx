...
import LoginUserImg from "../assets/LoginUserImg.png"
...
const LogInUser = () => {
  ...
  return (
   ...
   <div className="Loginuser">
    <div className="LoginUser-Img">
        <img src={LoginUserImg} alt="LoginUser" />
    </div>
    ...
    <PhoneInput  defaultCountry="IN" value={Phone} onChange={setPhone} placeholder='Enter the Phone No.' required/>
       <input type="text" className='Input-Address' value={Address} onChange={(e)=>{
